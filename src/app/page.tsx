      ...
      <section className="relative h-[90vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-8 text-center text-white max-w-4xl space-y-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 animate-fade-in-up [animation-delay:1000ms]">
            <Link 
              href="/products" 
              className="group w-full sm:w-auto px-8 md:px-12 py-4 md:py-6 bg-white/10 backdrop-blur-md border border-white/20 text-white font-black uppercase tracking-widest text-[10px] md:text-xs rounded-full shadow-2xl hover:bg-white hover:text-black transition-all duration-700 flex items-center justify-center gap-2"
            >
            ...
            <button 
              ...
              className="w-full sm:w-auto px-8 md:px-12 py-4 md:py-6 bg-whatsapp text-white font-black uppercase tracking-widest text-[10px] md:text-xs rounded-full shadow-xl hover:scale-105 transition-all duration-500 flex items-center justify-center gap-3 animate-whatsapp-pulse"
            >
