...
export default function Homepage() {
  ...
  return (
    <div className="flex flex-col gap-0 -mt-8">
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[95vh] md:h-[90vh] w-full flex items-center justify-center overflow-hidden py-24 md:py-0">
        ...
        <div className="relative z-10 px-8 text-center text-white max-w-4xl space-y-8 md:space-y-12">
          <div className="flex justify-center animate-fade-in-up [animation-delay:200ms]">
            <span className="px-6 py-2.5 rounded-full border border-white/20 backdrop-blur-xl text-[9px] md:text-[10px] font-bold uppercase tracking-[0.4em] bg-white/5 text-brand-rosegold shadow-2xl">
              Curated for the Sophisticated
            </span>
          </div>

          <div className="space-y-6 animate-fade-in-up [animation-delay:600ms]">
            <h1 className="text-4xl md:text-8xl font-serif leading-[1.1] tracking-tight">
              Pure <span className="italic">Radiance</span> <br /> 
              <span className="text-brand-rosegold">Defined.</span>
            </h1>
            <p className="text-sm md:text-2xl text-white/70 font-light max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 animate-fade-in-up [animation-delay:1000ms]">
            <Link 
              href="/products" 
              className="group w-full sm:w-auto px-8 md:px-12 py-4.5 md:py-6 bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold uppercase tracking-widest text-[10px] md:text-xs rounded-full shadow-2xl hover:bg-white hover:text-black transition-all duration-700 flex items-center justify-center gap-2"
            >
            ...
            <button 
              ...
              className="w-full sm:w-auto px-8 md:px-12 py-4.5 md:py-6 bg-whatsapp text-white font-bold uppercase tracking-widest text-[10px] md:text-xs rounded-full shadow-xl hover:scale-105 transition-all duration-500 flex items-center justify-center gap-3 animate-whatsapp-pulse"
            >
      ...
      <section className="py-24 px-6 bg-gray-50/50 dark:bg-black/20">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-3 md:space-y-4">
            <h2 className="text-3xl md:text-5xl font-serif tracking-tight">Shop Categories</h2>
            <div className="w-16 md:w-20 h-1 bg-brand-rosegold mx-auto"></div>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="grid grid-cols-1 gap-6">
            {[
              ...
              <div key={idx} className="group flex gap-6 md:gap-8 p-6 md:p-10 bg-white/5 border border-white/10 rounded-[2.5rem] hover:bg-white/10 hover:border-brand-rosegold/50 transition-all duration-500 shadow-2xl">
                 <span className="text-3xl md:text-4xl font-serif italic text-brand-rosegold/50 group-hover:text-brand-rosegold transition-colors">{item.step}</span>
                 <div className="space-y-2 md:space-y-3">
                    <h4 className="text-xl md:text-2xl font-bold tracking-tight">{item.title}</h4>
                    <p className="text-white/80 font-normal leading-relaxed group-hover:text-white transition-colors text-xs md:text-sm">
                      {item.desc}
                    </p>
                 </div>
              </div>
      ...
      <section className="py-32 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-10 md:space-y-12 relative z-10">
          <h2 className="text-4xl md:text-8xl font-serif leading-none italic tracking-tighter text-brand-plum dark:text-brand-rosegold">Ready to <br /> Glow?</h2>
          <p className="text-gray-500 text-base md:text-xl font-light max-w-lg mx-auto leading-relaxed px-4">Join thousand of women in Ghana who choose Glow by Connie for their premium beauty needs.</p>
          <div className="pt-4 md:pt-6">
            <button 
              onClick={() => window.open(`https://wa.me/233246702043`, '_blank')}
              className="px-10 md:px-14 py-4 md:py-6 bg-whatsapp text-white font-black uppercase tracking-[0.2em] text-xs md:text-sm rounded-full shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-4 mx-auto animate-whatsapp-pulse"
            >
